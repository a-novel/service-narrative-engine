...
func TestSchemaMetaSelect(t *testing.T) {
	...
	testCases := []struct {
		...
		request *dao.SchemaMetaSelectRequest

		expect    *dao.SchemaMeta
		expectErr error
	}{
		{
			name: "Success/ByID/Latest",
		...
		{
			name: "Success/ByID/EmptyDataIsNotNil",
		...
		{
			name: "Success/IsLatestOnlyForSameModule",
		...
		},
		{
			...
			expectErr: dao.ErrSchemaMetaSelectNotFound,
		},
		{
	...
	repository := dao.NewSchemaMetaSelect()
