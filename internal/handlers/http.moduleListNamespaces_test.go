...
func TestModuleListNamespaces(t *testing.T) {
	...
	type serviceMock struct {
		req  *services.ModuleListNamespacesRequest
		resp []string
		err  error
	}
	...
	testCases := []struct {
	...
	}{
		{
			...
			expectResponse: []any{"alpha", "beta", "gamma"},
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			service := handlersmocks.NewMockModuleListNamespacesService(t)
			...
			handler := handlers.NewModuleListNamespaces(service, config.LoggerDev)
