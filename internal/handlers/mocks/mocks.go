...
// NewMockModuleListIDsService creates a new instance of MockModuleListIDsService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockModuleListIDsService(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockModuleListIDsService {
	mock := &MockModuleListIDsService{}
	mock.Mock.Test(t)
...
// MockModuleListIDsService is an autogenerated mock type for the ModuleListIDsService type
type MockModuleListIDsService struct {
	mock.Mock
}

type MockModuleListIDsService_Expecter struct {
	mock *mock.Mock
}

func (_m *MockModuleListIDsService) EXPECT() *MockModuleListIDsService_Expecter {
	return &MockModuleListIDsService_Expecter{mock: &_m.Mock}
}

// Exec provides a mock function for the type MockModuleListIDsService
func (_mock *MockModuleListIDsService) Exec(ctx context.Context, request *services.ModuleListIDsRequest) ([]string, error) {
	...
	var r0 []string
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *services.ModuleListIDsRequest) ([]string, error)); ok {
		return returnFunc(ctx, request)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *services.ModuleListIDsRequest) []string); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, *services.ModuleListIDsRequest) error); ok {
...
// MockModuleListIDsService_Exec_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Exec'
type MockModuleListIDsService_Exec_Call struct {
	*mock.Call
}
...
func (_e *MockModuleListIDsService_Expecter) Exec(ctx interface{}, request interface{}) *MockModuleListIDsService_Exec_Call {
	return &MockModuleListIDsService_Exec_Call{Call: _e.mock.On("Exec", ctx, request)}
}

func (_c *MockModuleListIDsService_Exec_Call) Run(run func(ctx context.Context, request *services.ModuleListIDsRequest)) *MockModuleListIDsService_Exec_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 *services.ModuleListIDsRequest
		if args[1] != nil {
			arg1 = args[1].(*services.ModuleListIDsRequest)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockModuleListIDsService_Exec_Call) Return(strings []string, err error) *MockModuleListIDsService_Exec_Call {
	_c.Call.Return(strings, err)
	return _c
}

func (_c *MockModuleListIDsService_Exec_Call) RunAndReturn(run func(ctx context.Context, request *services.ModuleListIDsRequest) ([]string, error)) *MockModuleListIDsService_Exec_Call {
	_c.Call.Return(run)
	return _c
}

// NewMockModuleListNamespacesService creates a new instance of MockModuleListNamespacesService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockModuleListNamespacesService(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockModuleListNamespacesService {
	mock := &MockModuleListNamespacesService{}
	mock.Mock.Test(t)
...
// MockModuleListNamespacesService is an autogenerated mock type for the ModuleListNamespacesService type
type MockModuleListNamespacesService struct {
	mock.Mock
}

type MockModuleListNamespacesService_Expecter struct {
	mock *mock.Mock
}

func (_m *MockModuleListNamespacesService) EXPECT() *MockModuleListNamespacesService_Expecter {
	return &MockModuleListNamespacesService_Expecter{mock: &_m.Mock}
}

// Exec provides a mock function for the type MockModuleListNamespacesService
func (_mock *MockModuleListNamespacesService) Exec(ctx context.Context, request *services.ModuleListNamespacesRequest) ([]string, error) {
	ret := _mock.Called(ctx, request)
	...
	var r0 []string
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *services.ModuleListNamespacesRequest) ([]string, error)); ok {
		return returnFunc(ctx, request)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *services.ModuleListNamespacesRequest) []string); ok {
		r0 = returnFunc(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]string)
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, *services.ModuleListNamespacesRequest) error); ok {
		r1 = returnFunc(ctx, request)
	} else {
		r1 = ret.Error(1)
	}
...
// MockModuleListNamespacesService_Exec_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Exec'
type MockModuleListNamespacesService_Exec_Call struct {
	*mock.Call
}
...
func (_e *MockModuleListNamespacesService_Expecter) Exec(ctx interface{}, request interface{}) *MockModuleListNamespacesService_Exec_Call {
	return &MockModuleListNamespacesService_Exec_Call{Call: _e.mock.On("Exec", ctx, request)}
}

func (_c *MockModuleListNamespacesService_Exec_Call) Run(run func(ctx context.Context, request *services.ModuleListNamespacesRequest)) *MockModuleListNamespacesService_Exec_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 *services.ModuleListNamespacesRequest
		if args[1] != nil {
			arg1 = args[1].(*services.ModuleListNamespacesRequest)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockModuleListNamespacesService_Exec_Call) Return(strings []string, err error) *MockModuleListNamespacesService_Exec_Call {
	_c.Call.Return(strings, err)
	return _c
}

func (_c *MockModuleListNamespacesService_Exec_Call) RunAndReturn(run func(ctx context.Context, request *services.ModuleListNamespacesRequest) ([]string, error)) *MockModuleListNamespacesService_Exec_Call {
	_c.Call.Return(run)
	return _c
}
